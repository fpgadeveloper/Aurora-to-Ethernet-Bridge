//////////////////////////////////////////////////////////////////////////////
// Filename:          C:\ML505\Tutorials\AEBridge/drivers/bridge_v1_00_a/src/bridge_selftest.c
// Version:           1.00.a
// Description:       Contains a diagnostic self-test function for the bridge driver
...
XStatus BRIDGE_SelfTest(void * baseaddr_p)
{
  ...
  BRIDGE_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = BRIDGE_mReadSlaveReg0(baseaddr, 0);
